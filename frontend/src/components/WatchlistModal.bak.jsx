      ...
      <div className="flex max-h-[85vh] w-full max-w-lg flex-col overflow-hidden rounded-xl border border-slate-700/80 bg-slate-950 shadow-2xl" onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleAdd} className="border-b border-slate-800/80 px-5 py-4">
          ...
          <label className="mt-2.5 block">
            ...
            <input value={reason} onChange={(e) => setReason(e.target.value)} placeholder="e.g. Stolen vehicle" maxLength={120} className="w-full rounded-md border border-slate-700 bg-black px-2.5 py-1.5 text-sm text-slate-200 placeholder:text-slate-600 focus:border-emerald-500/60 focus:outline-none" />
          </label>
